                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="mt-2">
                                ...
                                <input class="form-control" 
                                    id="title" type="text" value="${ post.title }" readonly />
                            </div>
                            <div class="mt-2">
                                <label class="form-label" for="content">내용</label>
                                <textarea class="form-control" 
                                    id="content" rows="5" readonly>${ post.content }</textarea>
                            </div>
                            <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <input class="form-control" 
                                    id="createdTime" type="text" value="${ post.createdTime }" readonly />
                            </div>
                            <div class="mt-2">
                                <label class="form-label" for="modifiedTime">최종수정시간</label>
                                <input class="form-control" 
                                    id="modifiedTime" type="text" value="${ post.modifiedTime }" readonly />
                            </div>
                        </form>
                    </div>
